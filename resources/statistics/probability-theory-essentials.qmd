...
**Next in the track:** [Sampling and Statistical Inference](sampling-and-inference.qmd) builds directly on these foundations, showing how we use probability to make principled inferences from samples to populations.

**For reference:** [Common Probability Distributions](common-probability-distributions.qmd) extends this page with an overview of binomial, Poisson, uniform, exponential, beta, and gamma distributions.
